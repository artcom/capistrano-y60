...
configuration.load do
  ...
  # Task hooks
  # --------------------------------------------
  after "deploy:setup", "y60component:setup_directory_structure" if :y60_components.any?
  after "deploy:setup", "y60component:update_ldconfig" if :y60_components.any?

  after "deploy:setup", "y60component:update_environment" if :y60_components.any?
